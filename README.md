# Yearly-Airline-Performance-And-Average-Flight-Delay
...
In the main branch can be found a Jupyter Notebook with the description of the needs and requierements of the dashboard, which are later diplayed and executed in a python file using a dash application.
